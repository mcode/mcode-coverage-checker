...
function App() {
  ...
  return (
    <div className="-mt-6 max-w-6xl">
      ...
      <div className="flex flex-row max-md:flex-wrap pb-5 gap-5 items-stretch">
        <MainVisualization
      ...
      <div className="flex flex-row max-md:flex-wrap gap-5 items-start">
        <SubcategoryTable
          className="h-[500px] lg:w-1/2 max-md:grow"
          selectedSection={selectedSection}
          coverageData={coverageData}
        />
        <Longitudinal
